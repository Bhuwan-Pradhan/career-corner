...
class CourseDetailsGJ extends StatefulWidget {
  ...
  @override
  State<CourseDetailsGJ> createState() => _CourseDetailsGJState();
}

class _CourseDetailsGJState extends State<CourseDetailsGJ>
...
class _ClassesState extends State<Classes> {
  ...
  void initState() {
    ...
    courseProvider.fetchClassData(widget.courseID);
    loading();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CourseProvider>(builder: (context, classData, index) {
